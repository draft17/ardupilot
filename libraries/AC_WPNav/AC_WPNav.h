...
public:
	...
	void processing_avoidance_clear() {
		_flags.processing_avoidance = false; do_avoid = 0; slowing_down_avoidance_time = 0; avoid_count = 0; obstacle_count = 0;
