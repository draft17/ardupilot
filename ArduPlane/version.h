...
#define THISFIRMWARE "ArduPlane V4.2.2.7"
/* 
 *	Version inform :
 ...
 *  ArduPlane V4.2.2.5 - qloiter, qhover mode center throttle 에서 prop 돌지 않게 수정.
 *  ArduPlane V4.2.2.6 - qhover mode에서 center throttle prop 돌지 않게 수정.
 *  ArduPlane V4.2.2.7 - arm -> disarm -> arm시에도 모터 안돌게 수정
 */
