...
#define FLOW_USE_TERRAIN 2
    ...
    const uint16_t posRetryTimeUseVel_ms = 2000;  // Position aiding retry time with velocity measurements (msec)
    const uint16_t posRetryTimeNoVel_ms = 1000;    // Position aiding retry time without velocity measurements (msec)
