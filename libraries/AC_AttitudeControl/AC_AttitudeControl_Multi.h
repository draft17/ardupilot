...
public:
    ...
    //bool is_throttle_mix_min() const override { return (_throttle_rpy_mix < 1.25f * _thr_mix_min); } // YIG-CHG
    bool is_throttle_mix_min() const override { return (_throttle_rpy_mix < 2.0f * _thr_mix_min); }
